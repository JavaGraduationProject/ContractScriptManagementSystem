...
export default {
  ...
  computed: {
    zongjia:{
      get: function () {
        return 1*this.ruleForm.jiage*this.ruleForm.canyurenshu
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        this.ruleForm.canyurenshu = 0
	this.ro.canyurenshu = false;
      }
      // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.canyurenshu = obj.canyurenshu - this.ruleForm.canyurenshu
	      if(obj.canyurenshu<0){
