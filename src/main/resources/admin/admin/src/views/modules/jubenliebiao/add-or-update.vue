<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剧本名" prop="jubenming">
          <el-input v-model="ruleForm.jubenming" 
              placeholder="剧本名" clearable  :readonly="ro.jubenming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剧本名" prop="jubenming">
              <el-input v-model="ruleForm.jubenming" 
                placeholder="剧本名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="剧本类型" prop="jubenleixing">
          <el-input v-model="ruleForm.jubenleixing" 
              placeholder="剧本类型" clearable  :readonly="ro.jubenleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="剧本类型" prop="jubenleixing">
              <el-input v-model="ruleForm.jubenleixing" 
                placeholder="剧本类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="介绍" prop="jieshao">
          <el-input v-model="ruleForm.jieshao" 
              placeholder="介绍" clearable  :readonly="ro.jieshao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="介绍" prop="jieshao">
              <el-input v-model="ruleForm.jieshao" 
                placeholder="介绍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="游戏时间" prop="youxishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.youxishijian" 
                type="datetime"
                placeholder="游戏时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxishijian" label="游戏时间" prop="youxishijian">
              <el-input v-model="ruleForm.youxishijian" 
                placeholder="游戏时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bianhao = true;
          ...
          if(o=='jubenming'){
            this.ruleForm.jubenming = obj[o];
	    this.ro.jubenming = true;
            continue;
          }
          if(o=='jubenleixing'){
            this.ruleForm.jubenleixing = obj[o];
	    this.ro.jubenleixing = true;
            continue;
          }
          if(o=='zuozhe'){
	    ...
	    this.ro.canyurenshu = true;
          ...
          if(o=='youxishijian'){
            this.ruleForm.youxishijian = obj[o];
	    this.ro.youxishijian = true;
            continue;
          }
          if(o=='longitude'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jubenliebiao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jubenliebiaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
